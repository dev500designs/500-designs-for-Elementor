 ...
 * @since 1.0.0
 */
class Widget_Video_500D extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Video 500', 'fhdesigns-elementor-widgets' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_video',
			[
				'label' => esc_html__( 'Video', 'fhdesigns-elementor-widgets' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'youtube',
				'options' => [
					'youtube' => esc_html__( 'YouTube', 'fhdesigns-elementor-widgets' ),
					'vimeo' => esc_html__( 'Vimeo', 'fhdesigns-elementor-widgets' ),
					'dailymotion' => esc_html__( 'Dailymotion', 'fhdesigns-elementor-widgets' ),
					'hosted' => esc_html__( 'Self Hosted', 'fhdesigns-elementor-widgets' ),
				],
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Enter your URL', 'fhdesigns-elementor-widgets' ) . ' (YouTube)',
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Enter your URL', 'fhdesigns-elementor-widgets' ) . ' (Vimeo)',
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Enter your URL', 'fhdesigns-elementor-widgets' ) . ' (Dailymotion)',
		...
		$this->add_control(
			'hosted_url',
			[
				'label' => esc_html__( 'Choose File', 'fhdesigns-elementor-widgets' ),
		...
		$this->add_control(
			'external_url',
			[
				'label' => esc_html__( 'URL', 'fhdesigns-elementor-widgets' ),
		...
		$this->add_control(
			'start',
			[
				'label' => esc_html__( 'Start Time', 'fhdesigns-elementor-widgets' ),
				'type' => Controls_Manager::NUMBER,
				'description' => esc_html__( 'Specify a start time (in seconds)', 'fhdesigns-elementor-widgets' ),
				'frontend_available' => true,
			]
		);
		...
		$this->add_control(
			'end',
			[
				'label' => esc_html__( 'End Time', 'fhdesigns-elementor-widgets' ),
				'type' => Controls_Manager::NUMBER,
				'description' => esc_html__( 'Specify an end time (in seconds)', 'fhdesigns-elementor-widgets' ),
				'condition' => [
		...
		$this->add_control(
			'video_options',
			[
				'label' => esc_html__( 'Video Options', 'fhdesigns-elementor-widgets' ),
		...
		$this->add_control(
			'autoplay',
			[
				'label' => esc_html__( 'Autoplay', 'fhdesigns-elementor-widgets' ),
				'type' => Controls_Manager::SWITCHER,
				'frontend_available' => true,
				'conditions' => [
					'relation' => 'or',
		...
		$this->add_control(
			'play_on_mobile',
			[
				'label' => esc_html__( 'Play On Mobile', 'fhdesigns-elementor-widgets' ),
				'type' => Controls_Manager::SWITCHER,
				'condition' => [
					'autoplay' => 'yes',
				],
		...
		$this->add_control(
			'mute',
			[
				'label' => esc_html__( 'Mute', 'fhdesigns-elementor-widgets' ),
				'type' => Controls_Manager::SWITCHER,
				'frontend_available' => true,
			]
		);
		...
		$this->add_control(
			'controls',
			[
				'label' => esc_html__( 'Player Controls', 'fhdesigns-elementor-widgets' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'Hide', 'fhdesigns-elementor-widgets' ),
				'label_on' => esc_html__( 'Show', 'fhdesigns-elementor-widgets' ),
				'default' => 'yes',
				'condition' => [
					'video_type!' => 'vimeo',
				],
		...
		$this->add_control(
			'showinfo',
			[
				'label' => esc_html__( 'Video Info', 'fhdesigns-elementor-widgets' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'Hide', 'fhdesigns-elementor-widgets' ),
				'label_on' => esc_html__( 'Show', 'fhdesigns-elementor-widgets' ),
				'default' => 'yes',
		...
		$this->add_control(
			'modestbranding',
			[
				'label' => esc_html__( 'Modest Branding', 'fhdesigns-elementor-widgets' ),
				'type' => Controls_Manager::SWITCHER,
				'condition' => [
					'video_type' => [ 'youtube' ],
					'controls' => 'yes',
		...
		$this->add_control(
			'logo',
			[
				'label' => esc_html__( 'Logo', 'fhdesigns-elementor-widgets' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'Hide', 'fhdesigns-elementor-widgets' ),
				'label_on' => esc_html__( 'Show', 'fhdesigns-elementor-widgets' ),
				'default' => 'yes',
		...
		$this->add_control(
			'yt_privacy',
			[
				'label' => esc_html__( 'Privacy Mode', 'fhdesigns-elementor-widgets' ),
				'type' => Controls_Manager::SWITCHER,
				'description' => esc_html__( 'When you turn on privacy mode, YouTube won\'t store information about visitors on your website unless they play the video.', 'fhdesigns-elementor-widgets' ),
				'condition' => [
					'video_type' => 'youtube',
				],
				'frontend_available' => true,
		...
		$this->add_control(
			'lazy_load',
			[
				'label' => esc_html__( 'Lazy Load', 'fhdesigns-elementor-widgets' ),
				'type' => Controls_Manager::SWITCHER,
				'conditions' => [
					'relation' => 'or',
					'terms' => [
		...
		$this->add_control(
			'rel',
			[
				'label' => esc_html__( 'Suggested Videos', 'fhdesigns-elementor-widgets' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'' => esc_html__( 'Current Video Channel', 'fhdesigns-elementor-widgets' ),
					'yes' => esc_html__( 'Any Video', 'fhdesigns-elementor-widgets' ),
				],
				'condition' => [
					'video_type' => 'youtube',
				],
		...
		$this->add_control(
			'vimeo_title',
			[
				'label' => esc_html__( 'Intro Title', 'fhdesigns-elementor-widgets' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'Hide', 'fhdesigns-elementor-widgets' ),
				'label_on' => esc_html__( 'Show', 'fhdesigns-elementor-widgets' ),
				'default' => 'yes',
		...
		$this->add_control(
			'vimeo_portrait',
			[
				'label' => esc_html__( 'Intro Portrait', 'fhdesigns-elementor-widgets' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'Hide', 'fhdesigns-elementor-widgets' ),
				'label_on' => esc_html__( 'Show', 'fhdesigns-elementor-widgets' ),
				'default' => 'yes',
		...
		$this->add_control(
			'vimeo_byline',
			[
				'label' => esc_html__( 'Intro Byline', 'fhdesigns-elementor-widgets' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'Hide', 'fhdesigns-elementor-widgets' ),
				'label_on' => esc_html__( 'Show', 'fhdesigns-elementor-widgets' ),
				'default' => 'yes',
		...
		$this->add_control(
			'color',
			[
				'label' => esc_html__( 'Controls Color', 'fhdesigns-elementor-widgets' ),
		...
		$this->add_control(
			'download_button',
			[
				'label' => esc_html__( 'Download Button', 'fhdesigns-elementor-widgets' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'Hide', 'fhdesigns-elementor-widgets' ),
				'label_on' => esc_html__( 'Show', 'fhdesigns-elementor-widgets' ),
				'condition' => [
		...
		$this->add_control(
			'poster',
			[
				'label' => esc_html__( 'Poster', 'fhdesigns-elementor-widgets' ),
				'type' => Controls_Manager::MEDIA,
				'dynamic' => [
					'active' => true,
				],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Image Overlay', 'fhdesigns-elementor-widgets' ),
			]
		);
		...
		$this->add_control(
			'show_play_icon',
			[
				'label' => esc_html__( 'Play Icon', 'fhdesigns-elementor-widgets' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'condition' => [
					'show_image_overlay' => 'yes',
		...
		$this->add_control(
			'play_icon',
			[
				'label' => esc_html__( 'Icon', 'fhdesigns-elementor-widgets' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SWITCHER,
				'frontend_available' => true,
				'label_off' => esc_html__( 'Off', 'fhdesigns-elementor-widgets' ),
				'label_on' => esc_html__( 'On', 'fhdesigns-elementor-widgets' ),
				'condition' => [
					'show_image_overlay' => 'yes',
					'image_overlay[url]!' => '',
				],
		...
		$this->add_control(
			'aspect_ratio',
			[
				'label' => esc_html__( 'Aspect Ratio', 'fhdesigns-elementor-widgets' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'169' => '16:9',
					'219' => '21:9',
		...
		$this->add_control(
			'play_icon_color',
			[
				'label' => esc_html__( 'Color', 'fhdesigns-elementor-widgets' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			'play_icon_size',
			[
				'label' => esc_html__( 'Size', 'fhdesigns-elementor-widgets' ),
		...
		$this->add_group_control(
			...
			[
				...
				'fields_options' => [
					'text_shadow_type' => [
						'label' => _x( 'Shadow', 'Text Shadow Control', 'fhdesigns-elementor-widgets' ),
					],
				],
				'condition' => [
					'show_image_overlay' => 'yes',
		...
		$this->add_control(
			'lightbox_color',
			[
				'label' => esc_html__( 'Background Color', 'fhdesigns-elementor-widgets' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'lightbox_ui_color',
			[
				'label' => esc_html__( 'UI Color', 'fhdesigns-elementor-widgets' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'UI Hover Color', 'fhdesigns-elementor-widgets' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Content Width', 'fhdesigns-elementor-widgets' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'unit' => '%',
				],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Content Position', 'fhdesigns-elementor-widgets' ),
				'type' => Controls_Manager::SELECT,
				'frontend_available' => true,
				'options' => [
					'' => esc_html__( 'Center', 'fhdesigns-elementor-widgets' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Entrance Animation', 'fhdesigns-elementor-widgets' ),
	...
	public function print_a11y_text( $image_overlay ) {
		if ( empty( $image_overlay['alt'] ) ) {
			echo esc_html__( 'Play Video', 'fhdesigns-elementor-widgets' );
		} else {
			echo esc_html__( 'Play Video about', 'fhdesigns-elementor-widgets' ) . ' ' . esc_attr( $image_overlay['alt'] );
		}
	}
