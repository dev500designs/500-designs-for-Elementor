<?php
/**
 * fhdesigns_Elementor_Widgets class.
 *
 * @category   Class
...
/**
 * Main 500 Designs Elementor Widgets Class
 *
 * The init class that runs the 500 Designs Elementor Widgets plugin.
 ...
 */
final class fhdesigns_Elementor_Widgets {
	...
	public function i18n() {
		load_plugin_textdomain( 'fhdesigns-elementor-widgets' );
	}
	...
	public function init() {
		...
		elseif ( version_compare( PHP_VERSION, self::MINIMUM_PHP_VERSION, '<' ) ) {
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( FHDESIGNS_ELEMENTOR_WIDGETS ) );
...
// Instantiate fhdesigns_Elementor_Widgets.
new fhdesigns_Elementor_Widgets();
